...
```
# How to Use
In order to run this code, you must activate a Python environment installed on your computer and activated. Download the Iris.py or Iris_Classes.py (this one is organized into classes) along side the CSV file onto your computer into a folder. Then open that folder/file on VSCode. 
